...
use constant PROPER_PAIR =>
        ( \(join "\t",'HS17_08691:6:1210:6217:36448',99,'1','10002','0','100M','=','10010','108','ACGT','EEEE'),
          \(join "\t",'HS17_08691:6:1210:6217:36448',147,'1','10010','25','100M','=','10002','-108','ACGT','EEEE') );

use constant UNMAPPED_PAIR =>
        ( \(join "\t",'HS20_08443:7:1101:10000:18717',77,'*','0','0','*','*','0','0','ACGT','EEEE'),
          \(join "\t",'HS20_08443:7:1101:10000:18717',141,'*','0','0','*','*','0','0','ACGT','EEEE') );

use constant SINGLE_END_MAPPED =>
        ( \(join "\t",'HS25_09078:8:1112:19570:49276',89,'1','9992',37,'2S3M1D95M','=','9992','0','ACGT','EEEE'),
          \(join "\t",'HS25_09078:8:1112:19570:49276',181,'1','9992','0','*','=','9992','0','ACGT','EEEE') );


use constant INTER_CHROM_MAPPED =>
        ( \(join "\t",'HS25_09078:8:2110:14096:65629',65,'1','213325515',37,'63M1D37M','2','126897','0','ACGT','EEEE'),
          \(join "\t",'HS25_09078:8:2110:14096:65629',129,'2','126897',23,'6M1D94M','1','213325515','0','ACGT','EEEE') );

use constant ABERRANT_MAPPED =>
        ( \(join "\t",'HS17_08691:6:1209:11505:95018',145,'1','16387',25,'100M','=','16393','-94','ACGT','EEEE'),
          \(join "\t",'HS17_08691:6:1209:11505:95018',97,'1','16393',37,'94M2D3M3S','=','16387','94','ACGT','EEEE') );

use constant MAPQ_ORDER_GOOD =>
        ( \(join "\t",'HS17_08691:6:1209:11505:95018',81,'1','16387',37,'100M','=','16393','-94','ACGT','EEEE'),
          \(join "\t",'HS17_08691:6:1209:11505:95018',161,'1','16393',0,'94M2D3M3S','=','16387','94','TGCA','EEEE') );

use constant MAPQ_ORDER_GOOD_OUT => qq{>HS17_08691:6:1209:11505:95018\t1\t16387\tABERRANT\t-\nTGCA\n};

use constant MAPQ_ORDER_SWAP =>
        ( \(join "\t",'HS17_08691:6:1209:11505:95018',81,'1','16387',0,'100M','=','16393','-94','ACGT','EEEE'),
          \(join "\t",'HS17_08691:6:1209:11505:95018',161,'1','16393',37,'94M2D3M3S','=','16387','94','TGCA','EEEE') );
...
# this needs more work as this is just the same as 1_pm_compile.t
